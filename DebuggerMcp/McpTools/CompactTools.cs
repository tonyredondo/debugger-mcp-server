...
public sealed class CompactTools
{
    ...
    public Task<string> Report(
        ...
        [Description("Include watches in generated report data (default: true; affects full/index/get)")] bool includeWatches = true,
        [Description("Include security analysis in generated report data (default: true; affects full/index/get)")] bool includeSecurity = true,
