...
| Property | Value |
|----------|-------|
| **Generated** | 2025-12-09 14:41:56 UTC |
...
| 112 | `<wdT` |
| 113 | `x86_64` |
| 114 | `/project/profiler/_build/bin/Release-x64/profiler/src/Demos/Samples.BuggyBits/net8.0/Samples.BuggyBits` |
| 115 | `--timeout` |
| 116 | `10` |
| 117 | `--urls` |
| 118 | `http://localhost:44325` |
...
*Timestamp: 2025-12-09 14:41:56 UTC*
