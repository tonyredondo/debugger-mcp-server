...
internal static class LlmSystemPrompts
{
        ...
        bool agentConfirmationEnabled)
    {
        ...
        sb.AppendLine("- If you recommend commands, write them exactly as the user should run them in the CLI.");
        ...
        sb.AppendLine("- inspect_object({address,maxDepth?}): inspect a .NET object at an address");
