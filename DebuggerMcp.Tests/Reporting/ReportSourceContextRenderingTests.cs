...
public class ReportSourceContextRenderingTests
{
    ...
    [Fact]
    public void GenerateMarkdownReport_WhenSourceContextResolved_RendersCodeFenceSnippet()
    {
    ...
    [Fact]
    public void GenerateHtmlReport_WhenSourceContextResolved_RendersHighlightedCodeBlock()
    {
        var handler = new CountingHandler(_ => new HttpResponseMessage(HttpStatusCode.OK)
        {
            Content = new StringContent("line 1\nline 2\nline 3\nline 4\nline 5\nline 6\nline 7\n", Encoding.UTF8, "text/plain")
